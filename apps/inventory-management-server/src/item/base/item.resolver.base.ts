...
export class ItemResolverBase {
  ...
  @graphql.ResolveField(() => [StockMovement], { name: "stockMovements" })
  async findStockMovements(
    @graphql.Parent() parent: Item,
    @graphql.Args() args: StockMovementFindManyArgs
  ): Promise<StockMovement[]> {
    const results = await this.service.findStockMovements(parent.id, args);
  ...
  async getSupplier(@graphql.Parent() parent: Item): Promise<Supplier | null> {
